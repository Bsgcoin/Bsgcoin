...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    else if (nHeight > 1499 && nHeight <= 40000) {
    ...
    else if (nHeight > 400000 && nHeight <= 1000000) {
        nSubsidy = 8 * COIN;
    }
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if (pindexBest->nHeight+1 > 1500 && pindexBest->nHeight+1 <= 40001)  {
        nSubsidy = 35 * COIN;
    }
    else if (pindexBest->nHeight+1 > 40001 && pindexBest->nHeight+1 <= 200001)  {
        nSubsidy = 26 * COIN;
    }
    else if (pindexBest->nHeight+1 > 200001 && pindexBest->nHeight+1 <= 400001) {
        nSubsidy = 18 * COIN;
    }
    else if (pindexBest->nHeight+1 > 400001 && pindexBest->nHeight+1 <= 1000001) {
        nSubsidy = 12 * COIN;
    }
    else if (pindexBest->nHeight+1 > 1000001 && pindexBest->nHeight+1 <= 2000001) {
        nSubsidy = 8 * COIN;
    }
    else if (pindexBest->nHeight+1 > 2000001 && pindexBest->nHeight+1 <= 4000001) {
        nSubsidy = 6 * COIN;
    }
    else if (pindexBest->nHeight+1 > 4000001 && pindexBest->nHeight+1 <= 6000001) {
        nSubsidy = 2 * COIN;
    }
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue)
{
    ...
    if (nHeight < 1500) {
	ret = 0;
    } else if (nHeight >= 1500 && nHeight <= 40000) {
        ret = blockValue * 25 / 35; // MN Reward 71%
    } else if (nHeight > 40000 && nHeight <= 200000) {
        ret = blockValue * 17 / 26; // MN Reward 65%
    } else if (nHeight > 200000 && nHeight <= 400000) {
        ret = blockValue * 11 / 18; // MN Reward 61%
    } else if (nHeight > 400000 && nHeight <= 1000000) {
        ret = blockValue * 7 / 12; // MN Reward 58%
    } else if (nHeight > 1000000) {
        ret = blockValue * 1 / 2; // MN Reward 50%
    }
    return ret;
}
