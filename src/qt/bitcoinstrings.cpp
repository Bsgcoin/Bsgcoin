...
"for example: alertnotify=echo %%s | mail -s \"Bsgcoin Alert\" admin@foo."
"com\n"),
QT_TRANSLATE_NOOP("bitcoin-core", ""
...
QT_TRANSLATE_NOOP("bitcoin-core", "Initialization sanity check failed. Bsgcoin is shutting down."),
