    ...
    nWeight(0)
{
...
#endif
    setObjectName("bsgcoin");
    setStyleSheet("#bsgcoin { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
    ...
    if (!fUseBlackTheme)
    {
        ...
        {
            progressBar->setStyleSheet("QProgressBar { color: #1f35ed;background-color: #e8e8e8; border: 1px solid grey; border-radius: 5px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #a6dcf3, stop: 1 #60d2e9); border-radius: 5px; margin: 0px; }");
        }
    }
    ...
    statusBar()->setStyleSheet("#statusBar { color: #1f35ed; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 0.6, stop: 0 #60d2e9, stop: 1 #a6dcf3);  }");
...
void BitcoinGUI::createActions()
{
   ...
   // connect(TradingAction, SIGNAL(triggered()), this, SLOT(gotoTradingPage()));
    ...
    aboutAction = new QAction(QIcon(":/icons/aboutbsgcoin"), tr("&About Bsgcoin"), this);
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #1f35ed; font-weight:bold;} QToolButton:hover { background-color: #a6dcf3 } QToolButton:checked { background-color: #a6dcf3 } QToolButton:pressed { background-color: #a6dcf3 } #tabs { color: #1f35ed; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 0.6, stop: 0 #a6dcf3, stop: 1 #60d2e9);  }");
...
void BitcoinGUI::setNumBlocks(int count)
{
    ...
    else
    {
        ...
        progressBarLabel->setStyleSheet("QLabel { color: #1f35ed; }");
