...
If you want to build Bsgcoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a bsgcoin-qt executable will be
built by default.
...
# Pick some path to install BDB to, here we create a directory within the bsgcoin directory
BDB_PREFIX="${BSGCOIN_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
# Configure Bsgcoin Core to use our own-built instance of BDB
cd $BSGCOIN_ROOT
./autogen.sh
...
2) The release is built with GCC and then "strip bsgcoind" to strip the debug
symbols, which reduces the executable size by about 90%.


To Build Bsgcoind with compile script
---------------------
...
Security
---------------------
To help make your bsgcoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, bsgcoin should be built with a non-executable stack
